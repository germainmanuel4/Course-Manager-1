...
<script runat="server">
    ...
    Dim UG = 360  'Undergrauate
    Dim GD = 120    'Graduate Diploma
    Dim MC = 180   'Masters by CourseWork
    Dim MR = 240   'Masters by Research
    ...
    Sub getCreditPoints()
        ...
        If courseType = "1" And 360 - totalCreditPoints > 0 Then
        ...
        ElseIf courseType = "2" And 120 - totalCreditPoints > 0 Then
        ...
        ElseIf courseType = "3" And 180 - totalCreditPoints > 0 Then
        ...
        ElseIf courseType = "4" And 240 - totalCreditPoints > 0 Then
    ...
    sub getCourseAverage()
        ...
        do while counter < 31
            ...
            counter = counter + 1
        Loop
        If sumOfUnits > 0 And totalUnitsAttempted = 0 Or sumOfUnits = 0 And totalUnitsAttempted > 0 Or sumOfUnits > 0 And totalUnitsAttempted > 0 Then
    ...
    Sub courseProgressCheck()
        ...
        If courseType = "1" Then                     'for undergraduate students 
            If totalCreditPoints >= UG Then       'if completed 66 percent above, then check all marks 
        ...
        If courseType = "2" Then                     'for graduate diploma students do this
            If totalCreditPoints >= GD Then       'if completed 66 percent above, then check all marks 
                If marks1 <= "49" Or marks2 <= "49" Or marks3 <= "49" Or marks4 <= "49" Or marks5 <= "49" Or marks6 <= "49" Or marks7 <= "49" Or marks8 <= "49" Or marks9 <= "49" Or marks10 <= "49" Or marks11 <= "49" Or marks12 <= "49" Or marks13 <= "49" Or marks14 <= "49" Or marks15 <= "49" Or marks16 <= "49" Or marks17 <= "49" Or marks18 <= "49" Or marks19 <= "49" Or marks20 <= "49" Or marks21 <= "49" Or marks22 <= "49" Or marks23 <= "49" Or marks24 <= "49" Or marks26 <= "49" Or marks27 <= "49" Or marks28 <= "49" Or marks29 <= "49" Or marks30 <= "49" Then
                    'response.write("is working")
                    Do While countercoursetype < 31
                        UniMarks = Request.Form("UM_" + CStr(countercoursetype))
                        ...
                        If UniMarks >= "40" Then   '39
                            If UniMarks <= "45" Then  '46
                                Response.Write(unit & "   'Supplementary assesment'" & "<br />")      'print  for supplementary unit
                            Else
                            End If
                        Else
                        End If
                        ...
                        If UniMarks >= "46" Then 'check 46 to 47
                            If UniMarks <= "49" Then
                                Response.Write(unit & "   'Conceded Pass'" & "<br />")        ' print for conceded pass 
                            Else
                            End If
                        Else
                        End If
        ...
        If courseType = "3" Then                     'for masters coursework students do this
            If totalCreditPoints >= MC Then       'if completed 66 percent above, then check all possible marks
                If marks1 <= "49" Or marks2 <= "49" Or marks3 <= "49" Or marks4 <= "49" Or marks5 <= "49" Or marks6 <= "49" Or marks7 <= "49" Or marks8 <= "49" Or marks9 <= "49" Or marks10 <= "49" Or marks11 <= "49" Or marks12 <= "49" Or marks13 <= "49" Or marks14 <= "49" Or marks15 <= "49" Or marks16 <= "49" Or marks17 <= "49" Or marks18 <= "49" Or marks19 <= "49" Or marks20 <= "49" Or marks21 <= "49" Or marks22 <= "49" Or marks23 <= "49" Or marks24 <= "49" Or marks26 <= "49" Or marks27 <= "49" Or marks28 <= "49" Or marks29 <= "49" Or marks30 <= "49" Then
                    ...
                    Do While countercoursetype < 31
                        ...
                        If UniMarks >= "40" Then
                            If UniMarks <= "45" Then
                                Response.Write(unit & "   'Supplementary assesment'" & "<br />")     ' print for supplementary assesment unit
                            Else
                            End If
                        Else
                        End If
        ...
        If courseType = "4" Then                     'for masters research students do this
            If totalCreditPoints >= MR Then       'if completed 66 percent above, then check all marks 
                If marks1 <= "49" Or marks2 <= "49" Or marks3 <= "49" Or marks4 <= "49" Or marks5 <= "49" Or marks6 <= "49" Or marks7 <= "49" Or marks8 <= "49" Or marks9 <= "49" Or marks10 <= "49" Or marks11 <= "49" Or marks12 <= "49" Or marks13 <= "49" Or marks14 <= "49" Or marks15 <= "49" Or marks16 <= "49" Or marks17 <= "49" Or marks18 <= "49" Or marks19 <= "49" Or marks20 <= "49" Or marks21 <= "49" Or marks22 <= "49" Or marks23 <= "49" Or marks24 <= "49" Or marks26 <= "49" Or marks27 <= "49" Or marks28 <= "49" Or marks29 <= "49" Or marks30 <= "49" Then
                    ...
                    Do While countercoursetype < 31
                        ...
                        If UniMarks >= "40" Then
                            If UniMarks <= "45" Then
                                Response.Write(unit & "   'Supplementary assesment'" & "<br />")        'print supplementary assesment and the unit
                            Else
                            End If
                        Else
                        End If
                        ...
                        If UniMarks >= "46" Then
                            If UniMarks <= "49" Then
                                Response.Write(unit & "   'Conceded Pass'" & "<br />")        ' print conceded pass
                            Else
                            End If
                        Else
                        End If
        ...
        if coursetype = "1" and totalCreditPoints >= underGraduate  Then
            Response.Write("UnderGraduate 'COURSE COMPLETED" & "<br / >")          'print course completed



        ElseIf coursetype = "2" and totalCreditPoints >= graduateDiploma Then
            Response.Write("Graduate Diploma 'COURSE COMPLETED'" & "<br / >")       ' print course completed




        ElseIf coursetype = "3" and totalCreditPoints  >= mastersCourseWork Then
            Response.Write("Masters by Course Work 'COURSE COMPLETED'" & "<br / >")   'print course completed



        ElseIf coursetype = "4" and totalCreditPoints  >= mastersResearch Then
            Response.Write("Masters by Research 'COURSE COMPLETED'" & "<br / >")       'print course completed
...
<%
    ...
    Do while counter  < 31    'while not all units loop through
        ...
        'types of messages to be printed 
    ...
    'check if the form is ready then call the functions in order
